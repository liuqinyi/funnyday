    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'COUNTY' (" + //
                ...
                "'COUNTY_NAME' TEXT NOT NULL ," + // 1: county_name
    ...
    protected void bindValues(SQLiteStatement stmt, County entity) {
        ...
        stmt.bindString(2, entity.getCounty_name());
    ...
    public County readEntity(Cursor cursor, int offset) {
        County entity = new County( //
            ...
            cursor.getString(offset + 1), // county_name
    ...
    public void readEntity(Cursor cursor, County entity, int offset) {
        ...
        entity.setCounty_name(cursor.getString(offset + 1));
