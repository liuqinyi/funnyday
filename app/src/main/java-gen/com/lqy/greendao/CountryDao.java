...
public class CountryDao extends AbstractDao<Country, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Country_name = new Property(1, String.class, "county_name", false, "COUNTY_NAME");
        public final static Property Country_code = new Property(2, String.class, "county_code", false, "COUNTY_CODE");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'country' (" + //
                ...
                "'country_NAME' TEXT NOT NULL ," + // 1: country_name
    ...
    protected void bindValues(SQLiteStatement stmt, Country entity) {
        ...
        stmt.bindString(2, entity.getCountry_name());
    ...
    public Country readEntity(Cursor cursor, int offset) {
        Country entity = new Country( //
            ...
            cursor.getString(offset + 1), // country_name
    ...
    public void readEntity(Cursor cursor, Country entity, int offset) {
        ...
        entity.setCountry_name(cursor.getString(offset + 1));
